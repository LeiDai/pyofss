...
class CheckCoreRoutines(unittest2.TestCase):
    r"""
...
class CheckMethods(unittest2.TestCase):
    """
    Soliton example with periodic evolution. Fibre length is selected
    such that the peak power is the same as that of the initial pulse.
    """
    class Function():
